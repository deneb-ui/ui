...
const EditableloadingScreenDocsPage = () => {
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">EditableloadingScreen Component</h1>
      <p className="mb-6">
        The EditableloadingScreen component provides a customizable loading screen with editable text fields. It allows users to modify labels dynamically, making it suitable for applications that require real-time updates to loading states.
      </p>
      ...
      <pre className="bg-gray-100 p-4 rounded mb-6">
        {`<EditableloadingScreen
  itemPath="loadingScreen"
  data={{
    apexLabel: "Loading...",
    ignitingPerformanceLabel: "Please wait",
    calibratingV12ChassisLabel: "Initializing..."
  }}
/>`}
      </pre>
      ...
      <ul className="list-disc list-inside mb-6">
        <li>*.apexLabel</li>
        <li>*.ignitingPerformanceLabel</li>
        <li>*.calibratingV12ChassisLabel</li>
      </ul>
    </div>
  );
};

export default EditableloadingScreenDocsPage;