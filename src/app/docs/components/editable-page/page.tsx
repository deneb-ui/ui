  ...
  return (
    <div className="docs-page">
      ...
      <p className="component-description">
        The Editablepage component allows users to edit a page's title, description, and image directly in the UI. It provides a seamless way to manage content dynamically.
      </p>
