...
const EditableheaderDocsPage = () => {
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-4">Editableheader Component</h1>
      <p className="mb-6">
        The Editableheader component is a customizable header that allows users to edit text and images directly within the UI. It supports navigation items and provides a flexible structure for various use cases.
      </p>
...
>
  <div>Additional content can go here</div>
      ...
      <ul className="list-disc list-inside">
        ...
        <li>*.auraLabel</li>
        <li>*.labLabel</li>
        <li>*.precisionCellularLabel</li>
        <li>*.NAV_ITEMS[*].href</li>
        <li>*.NAV_ITEMS[*].name</li>
...
export default EditableheaderDocsPage;